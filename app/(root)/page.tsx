...
const App = () => {
  return (
    <>
      <main className="py-24 px-2 sm:p-0 sm:h-screen flex items-center justify-center">
        <div className="flex flex-col w-11/12 sm:w-2/3 gap-5">
          <h1 className="text-xl md:text-3xl lg:text-6xl font-extrabold leading-snug text-center">
            Incorporate{" "}
            <span className="text-green-900 italic">eco-friendly</span> habits
            into your daily life through recommendations, challenges and
            resources!
          </h1>
          <div className="flex items-center justify-center">
            <Link
              href="/auth/signup"
              className="lg:text-3xl text-white font-medium bg-black px-4 py-2 md:px-6 md:py-3 rounded-md"
            >
              Try now
            </Link>
          </div>
